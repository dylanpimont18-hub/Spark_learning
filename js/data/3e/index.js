/* =========================================================
   Spark Learning – data/3e/index.js
   Manifest des sous-modules 3e — chargés via <script> dans index.html
   =========================================================
   Ordre de chargement (à ajouter dans index.html) :
   1. js/data/3e/trigonometrie.js
   2. js/data/3e/3e-systemes.js
   3. js/data/3e/3e-thales.js
   4. js/data/3e/3e-arithmetique.js
