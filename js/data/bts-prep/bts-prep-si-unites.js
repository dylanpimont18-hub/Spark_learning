...
| Intensité lumineuse | $I_v$ | candela | cd |`,
      },
      {
        ...
        def: `Toutes les autres unités sont des combinaisons de ces 7 grandeurs de base :<br/><br/>
...
| pico | p | $10^{-12}$ | pF (picofarad) |`,
    ...
    method: {
      ...
      steps: [
        'Méthode universelle : multiplier par "1" sous forme de fraction d\'unités',
        'Exemple km/h → m/s : $72\\;\\text{km/h} = 72 \\times \\frac{1000\\;\\text{m}}{1\\;\\text{km}} \\times \\frac{1\\;\\text{h}}{3600\\;\\text{s}} = 20\\;\\text{m/s}$',
        'Vérification dimensionnelle : toute équation physique doit être homogène — les deux membres doivent avoir la même dimension',
        'Exemple : $[P = F \\times v]$ → $[\\text{N} \\times \\text{m/s}] = \\text{kg·m·s}^{-2} \\times \\text{m·s}^{-1} = \\text{kg·m}^2\\text{s}^{-3} = [\\text{W}]$ ✓',
      ],
    },

    example: {
      statement: 'Système International d\'Unités — 4 exemples par domaine',
      steps: [
        '<strong>Exemple 1 — Électrotechnique : unité du watt</strong> : $P = U \\times I$ → $[\\text{V} \\times \\text{A}] = [\\text{kg·m}^2\\text{s}^{-3}\\text{A}^{-1} \\times \\text{A}] = \\text{kg·m}^2\\text{s}^{-3} = \\text{W}$ ✓',
        '<strong>Exemple 2 — BTP : unité du pascal</strong> : $P = F/A$ → $[\\text{N/m}^2] = \\text{Pa}$. Exemple : $6\\;\\text{bar} = 6 \\times 10^5\\;\\text{Pa} = 0{,}6\\;\\text{MPa}$.',
        '<strong>Exemple 3 — Maintenance : énergie kWh vs joules</strong> : $P = 5{,}5\\;\\text{kW}$ pendant $8\\;\\text{h}$ → $W = 44\\;\\text{kWh} = 44 \\times 3{,}6 \\times 10^6\\;\\text{J} = 158{,}4\\;\\text{MJ}$.',
        '<strong>Exemple 4 — Chimie : la mole</strong> : $n = m/M$. Pour 180 g d\'eau ($M = 18\\;\\text{g/mol}$) : $n = 180/18 = 10\\;\\text{mol}$ ($6{,}022 \\times 10^{24}$ molécules).',
      ],
      answer: 'Vérification dimensionnelle : si les dimensions des deux membres sont identiques, l\'équation est homogène — sinon, elle est forcément fausse.',
    },
    ...
    formulas: [
      ...
      '<strong>km/h → m/s</strong> : diviser par $3{,}6$',
...
─────────────────────────────────────
  ...
  10⁻¹² p  pico   │  RF, capteurs précis (pF)
    ...
    recap: [
      ...
      '1 kWh = 3,6 MJ — 1 bar = 10⁵ Pa — 1 km/h = 1/3,6 m/s',
