window.MODULES.push({
  ...
  cours: {
    ...
    definitions: [
      { term: '7 grandeurs de base du SI', def: 'Longueur (m), Masse (kg), Temps (s), Intensité électrique (A), Température thermodynamique (K), Quantité de matière (mol), Intensité lumineuse (cd).' },
      { term: 'Unités dérivées essentielles', def: 'Force : N = kg·m·s⁻² — Pression : Pa = N/m² — Énergie : J = kg·m²·s⁻² — Puissance : W = J/s<br/>Charge : C = A·s — Tension : V = kg·m²·s⁻³·A⁻¹ — Résistance : Ω = V/A — Fréquence : Hz = s⁻¹' },
      { term: 'Préfixes SI', def: 'T ($10^{12}$), G ($10^9$), M ($10^6$), k ($10^3$), m ($10^{-3}$), μ ($10^{-6}$), n ($10^{-9}$), p ($10^{-12}$)<br/><strong>Attention</strong> : m (minuscule) = milli ($10^{-3}$) ≠ M (majuscule) = méga ($10^6$).' },
    ],

    method: {
      title: 'Convertir une unité et vérifier la cohérence',
      steps: [
        'Méthode universelle : multiplier par 1 sous forme de fraction d\'unités.<br/>Exemple : $72\\;\\text{km/h} = 72 \\times \\dfrac{1000\\;\\text{m}}{1\\;\\text{km}} \\times \\dfrac{1\\;\\text{h}}{3600\\;\\text{s}} = 20\\;\\text{m/s}$',
        '<strong>Vérification de cohérence dimensionnelle</strong> : les deux membres d\'une équation physique doivent avoir la même dimension.',
        'Exemple : $P = F \\times v$ → $[F \\times v] = \\text{N} \\times \\text{m/s} = \\text{kg·m·s}^{-2} \\times \\text{m·s}^{-1} = \\text{kg·m}^2\\text{s}^{-3} = \\text{W}$ ✓',
      ],
    },

    example: {
      statement: 'Quatre exemples : le watt, le pascal, l\'énergie en kWh, la mole.',
      steps: [
        '<strong>Électrotechnique : le watt</strong><br/>$P = U \\times I$ → $[\\text{V} \\times \\text{A}] = \\text{kg·m}^2\\text{s}^{-3}\\text{A}^{-1} \\times \\text{A} = \\text{kg·m}^2\\text{s}^{-3} = \\text{W}$ ✓',
        '<strong>BTP : le pascal</strong><br/>$p = F/A$ → $[\\text{N/m}^2] = \\text{Pa}$<br/>$6\\;\\text{bar} = 6 \\times 10^5\\;\\text{Pa} = 0{,}6\\;\\text{MPa} = 600\\;\\text{kPa}$',
        '<strong>Maintenance : kWh et joules</strong><br/>$P = 5{,}5\\;\\text{kW}$ pendant $8\\;\\text{h}$ → $W = 44\\;\\text{kWh} = 44 \\times 3{,}6 \\times 10^6\\;\\text{J} = 158{,}4\\;\\text{MJ}$',
        '<strong>Chimie : la mole</strong><br/>$n = m/M$ — Pour 180 g d\'eau ($M = 18\\;\\text{g/mol}$) : $n = 180/18 = 10\\;\\text{mol}$.',
      ],
      answer: 'Toujours vérifier la cohérence dimensionnelle d\'une équation. Un résultat sans unité est inutilisable.',
    },

    formulas: [
      '<strong>Pression</strong> : $P = F/A$ — $[\\text{Pa} = \\text{N/m}^2]$',
      '<strong>Puissance mécanique</strong> : $P = F \\times v$ — $[\\text{W} = \\text{N·m/s}]$',
      '<strong>Énergie</strong> : $W = P \\times t$ — $[\\text{J} = \\text{W·s}]$',
      '<strong>kWh → J</strong> : $1\\;\\text{kWh} = 3{,}6 \\times 10^6\\;\\text{J}$',
      '<strong>bar → Pa</strong> : $1\\;\\text{bar} = 10^5\\;\\text{Pa} = 100\\;\\text{kPa}$',
      '<strong>km/h → m/s</strong> : $\\times \\dfrac{1}{3{,}6}$',
      '<strong>Quantité de matière</strong> : $n = m/M$ — $[\\text{mol}]$',
    ],
