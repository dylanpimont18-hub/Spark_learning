window.MODULES.push({
  ...
  cours: {
    ...
    definitions: [
      {
        term: '7 grandeurs de base du SI',
        def: `| Grandeur | Symbole | Unité | Abréviation |
|----------|---------|-------|-------------|
| Longueur | $l$ | mètre | m |
...
| Débit volumique | — | m³/s | m³·s⁻¹ |`,
      ...
      {
        term: 'Préfixes SI',
        def: `| Préfixe | Symbole | Facteur | Exemple |
|---------|---------|---------|---------|
...
| pico | p | $10^{-12}$ | pF (picofarad) |`,
    ...
    method: {
      title: 'Méthode de conversion et de vérification dimensionnelle',
      steps: [
        `<strong>Convertir une unité</strong> — la méthode universelle est la <strong>multiplication par 1</strong> sous forme de fraction d'unités.<br/><br/>Exemple : convertir 72 km/h en m/s :<br/>$$72\\;\\frac{\\text{km}}{\\text{h}} = 72 \\times \\frac{1000\\;\\text{m}}{1\\;\\text{km}} \\times \\frac{1\\;\\text{h}}{3600\\;\\text{s}} = \\frac{72000}{3600}\\;\\frac{\\text{m}}{\\text{s}} = 20\\;\\frac{\\text{m}}{\\text{s}}$$`,
        `<strong>Vérifier la cohérence dimensionnelle</strong> — toute équation physique doit être homogène : les deux membres doivent avoir la même dimension.<br/><br/>Exemple : $P = F \\times v$ (puissance = force × vitesse)<br/>$[P] = \\text{W} = \\text{kg·m}^2\\text{s}^{-3}$<br/>$[F \\times v] = \\text{N} \\times \\text{m/s} = \\text{kg·m·s}^{-2} \\times \\text{m·s}^{-1} = \\text{kg·m}^2\\text{s}^{-3}$ ✓`,
      ],
    },

    example: {
      statement: 'Quatre exemples illustrent la maîtrise des unités SI dans les filières BTS techniques.',
      steps: [
        `<strong>Exemple 1 — Électrotechnique : unité du watt</strong><br/><br/>La puissance électrique $P = U \\times I$ :<br/>$[U \\times I] = \\text{V} \\times \\text{A} = \\text{W}$<br/><br/>En unités de base : $\\text{V} = \\text{kg·m}^2\\text{s}^{-3}\\text{A}^{-1}$, donc $\\text{V·A} = \\text{kg·m}^2\\text{s}^{-3} = \\text{W}$ ✓`,
        `<strong>Exemple 2 — BTP : unité du pascal</strong><br/><br/>La pression $P = F/A$ (force par unité de surface) : $[F/A] = \\text{N/m}^2 = \\text{Pa}$<br/><br/>En pratique, une pression de 6 bar s'exprime : $6\\;\\text{bar} = 6 \\times 10^5\\;\\text{Pa} = 0{,}6\\;\\text{MPa} = 600\\;\\text{kPa}$`,
        `<strong>Exemple 3 — Maintenance : énergie en kWh vs joules</strong><br/><br/>Un moteur consomme $P = 5{,}5\\;\\text{kW}$ pendant $t = 8\\;\\text{h}$ :<br/>$W = P \\times t = 5{,}5\\;\\text{kW} \\times 8\\;\\text{h} = 44\\;\\text{kWh}$<br/><br/>Conversion en joules : $44\\;\\text{kWh} = 44 \\times 3{,}6 \\times 10^6\\;\\text{J} = 1{,}584 \\times 10^8\\;\\text{J} = 158{,}4\\;\\text{MJ}$`,
        `<strong>Exemple 4 — Chimie : la mole</strong><br/><br/>La mole est la quantité de matière contenant $6{,}022 \\times 10^{23}$ entités (nombre d'Avogadro). La masse molaire relie masse et quantité : $n = m/M$.<br/><br/>Pour 180 g d'eau ($M_{\\text{H}_2\\text{O}} = 18\\;\\text{g/mol}$) : $n = 180/18 = 10\\;\\text{mol}$`,
      ],
      answer: 'La cohérence dimensionnelle est le premier contrôle de validité de tout calcul technique. Vérifier systématiquement que les membres d\'une équation ont les mêmes dimensions.',
    },
    ...
    formulas: [
      ...
      '<strong>km/h → m/s</strong> : $v_{\\text{m/s}} = v_{\\text{km/h}} \\times \\dfrac{1}{3{,}6}$',
...
─────────────────────────────────────
  ...
  10⁻¹² p  pico   │  RF, capteurs précis (pF)
    ...
    recap: [
      ...
      '$1\\;\\text{kWh} = 3{,}6\\;\\text{MJ}$ — $1\\;\\text{bar} = 10^5\\;\\text{Pa}$ — $1\\;\\text{km/h} = \\dfrac{1}{3{,}6}\\;\\text{m/s}$',
