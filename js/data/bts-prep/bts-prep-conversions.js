...
| rad/s | tr/min | $n = \\omega \\times 60 / (2\\pi)$ |`,
    ...
    method: {
      ...
      steps: [
        'Écrire la conversion comme une multiplication par "1" (fraction de valeurs égales) : $Q(\\text{m}^3/\\text{h}) = Q(\\text{l/min}) \\times \\frac{1\\;\\text{m}^3}{1000\\;\\text{l}} \\times \\frac{60\\;\\text{min}}{1\\;\\text{h}} = Q(\\text{l/min}) \\times 0{,}06$',
        'Cette méthode permet de ne jamais se tromper de sens (multiplier ou diviser)',
        '<strong>Règle du "passage par le SI"</strong> : quand on ne connaît pas la conversion directe, passer toujours par l\'unité SI : Unité A → Unité SI → Unité B',
      ],
    },

    example: {
      statement: 'Conversions terrain — 4 exemples issus de catalogues fabricants',
      steps: [
        '<strong>Exemple 1 — Hydraulique (Grundfos)</strong> : Débit $Q = 12\\;\\text{m}^3/\\text{h}$ → l/min : $12 \\times \\frac{1000}{60} = 200\\;\\text{l/min}$. HMT = 45 m → pression : $p = \\rho g h = 1000 \\times 9{,}81 \\times 45 = 441\\,450\\;\\text{Pa} \\approx 4{,}4\\;\\text{bar}$.',
        '<strong>Exemple 2 — Thermique (chaudière industrielle)</strong> : $250\\;\\text{kW} \\times 860 = 215\\,000\\;\\text{kcal/h} = 215\\;\\text{Mcal/h}$.',
        '<strong>Exemple 3 — Électrotechnique (moteur)</strong> : $n = 1450\\;\\text{tr/min}$ → $\\omega = 1450 \\times 0{,}1047 = 151{,}8\\;\\text{rad/s}$. Puissance $P = 5{,}5\\;\\text{kW}$ → couple $C = 5500 / 151{,}8 = 36{,}2\\;\\text{N·m}$.',
      ...
      answer: 'Méthode clé : multiplier par "1" (fraction de valeurs égales) pour ne jamais se tromper de sens. En cas de doute : passer par le SI.',
    },
