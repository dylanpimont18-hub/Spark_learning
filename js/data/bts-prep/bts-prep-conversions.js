window.MODULES.push({
  ...
  cours: {
    ...
    definitions: [
      {
        term: 'Pression',
        def: `1 bar = $10^5$ Pa = 100 kPa &nbsp;·&nbsp; 1 MPa = 10 bar &nbsp;·&nbsp; 1 atm = $1{,}013 \\times 10^5$ Pa &nbsp;·&nbsp; 1 psi = 6895 Pa<br/><br/>
Règle pratique : <strong>1 bar ≈ 10 m de colonne d'eau</strong> (pression hydrostatique : $p = \\rho g h$)`,
      },
      {
        term: 'Débit volumique',
        def: `1 m³/s = 1000 l/s &nbsp;·&nbsp; <strong>1 m³/h = 16,67 l/min</strong> &nbsp;·&nbsp; 1 l/min = 0,06 m³/h<br/><br/>
Facteur direct : $Q(\\text{m}^3/\\text{h}) = Q(\\text{l/min}) \\times 0{,}06$`,
      },
      {
        term: 'Énergie',
        def: `<strong>1 kWh = 3,6 MJ</strong> &nbsp;·&nbsp; 1 kcal = 4186 J &nbsp;·&nbsp; 1 kWh = 860 kcal &nbsp;·&nbsp; 1 BTU = 1055 J &nbsp;·&nbsp; 1 tep = 11 630 kWh`,
      },
      {
        term: 'Puissance',
        def: `<strong>1 kW = 860 kcal/h</strong> &nbsp;·&nbsp; 1 kcal/h = $1{,}163$ W &nbsp;·&nbsp; 1 ch (cheval-vapeur) = 736 W &nbsp;·&nbsp; 1 hp = 746 W`,
      },
      {
        term: 'Température',
        def: `$T(\\text{K}) = T(°\\text{C}) + 273{,}15$ &nbsp;·&nbsp; $T(°\\text{F}) = T(°\\text{C}) \\times 1{,}8 + 32$<br/><br/>
<strong>Attention :</strong> une <em>différence</em> $\\Delta T = 10°\\text{C} = 10\;\\text{K}$ ; une <em>valeur</em> $T = 10°\\text{C} = 283{,}15\;\\text{K}$.`,
      },
      {
        term: 'Vitesse de rotation',
        def: `$\\omega (\\text{rad/s}) = n (\\text{tr/min}) \\times \\dfrac{2\\pi}{60} \\approx n \\times 0{,}1047$<br/><br/>
$n (\\text{tr/min}) = \\omega (\\text{rad/s}) \\times \\dfrac{60}{2\\pi} \\approx \\omega \\times 9{,}55$`,
      },
    ],
    ...
    method: {
      ...
      steps: [
        ...
        `<strong>Règle du "passage par le SI"</strong> : quand on ne connaît pas la conversion directe, passer toujours par l'unité SI.<br/>Unité A → Unité SI → Unité B`,
      ],
    },

    example: {
      statement: 'Hydraulique (catalogue Grundfos) : pompe débitant $Q = 12\;\\text{m}^3/\\text{h}$ avec HMT 45 m',
      steps: [
        `Conversion débit en l/min : $12\;\\text{m}^3/\\text{h} \\times \\frac{1000\;\\text{l}}{\\text{m}^3} \\times \\frac{1\;\\text{h}}{60\;\\text{min}} = 200\;\\text{l/min}$`,
        `Conversion HMT en bar : $p = \\rho g h = 1000 \\times 9{,}81 \\times 45 = 441\\,450\;\\text{Pa} \\approx 4{,}4\;\\text{bar}$`,
        `<strong>Exemple 2 — Thermique (chaudière) :</strong> $250\;\\text{kW} \\times 860\;\\text{kcal/h par kW} = 215\\,000\;\\text{kcal/h} = 215\;\\text{Mcal/h}$`,
        `<strong>Exemple 3 — Électrotechnique (moteur) :</strong> $n = 1450\;\\text{tr/min}$ → $\\omega = 1450 \\times 0{,}1047 = 151{,}8\;\\text{rad/s}$<br/>Couple : $C = P / \\omega = 5500 / 151{,}8 = 36{,}2\;\\text{N·m}$`,
        `<strong>Exemple 4 — Climatisation (Daikin) :</strong> $P_f = 28\;\\text{kW}$, COP 3,2 → $P_{\\text{élec}} = 28 / 3{,}2 = 8{,}75\;\\text{kW}$ = $8750 / 736 \\approx 11{,}9\;\\text{ch}$`,
      ],
      answer: `Résultat : 200 l/min et $\\approx 4{,}4\;\\text{bar}$. Méthode universelle : multiplier par le rapport d'unités écrit comme fraction égale à 1.`,
    },
...
<div style="font-family:monospace;color:var(--text)">
  ...
  Temp.      : + 273,15 pour °C → K<br/>
    ...
    recap: [
      ...
      '°C → K : ajouter 273,15 (valeur absolue) ; différence °C = différence K',
