...
Le logarithme décimal $\\log_{10}(x)$ est la réciproque de $10^x$ : $\\log_{10}(10^x) = x$.<br/>
Relation : $\\ln(x) \\approx 2{,}303 \\times \\log_{10}(x)$`,
      },
      {
...
Si $a \\cdot e^{bx} = c$ → $e^{bx} = c/a$ → $bx = \\ln(c/a)$ → $x = \\ln(c/a)/b$`,
    ...
    method: {
      title: 'Décibels et constante de temps τ — deux applications majeures',
      steps: [
        'Décibels (puissance) : $L_P = 10 \\times \\log_{10}\\left(\\dfrac{P}{P_0}\\right)\\;\\text{dB}$',
        'Décibels (tension/pression) : $L = 20 \\times \\log_{10}\\left(\\dfrac{V}{V_0}\\right)\\;\\text{dB}$ (facteur 20 car $P \\propto V^2$)',
        'Valeurs repères : +3 dB ≈ doubler la puissance ; +6 dB ≈ doubler la tension ; +10 dB ≈ ×10 la puissance perçue',
        'Charge condensateur : $u_C(t) = E\\left(1 - e^{-t/\\tau}\\right)$ avec $\\tau = RC$. À $t = \\tau$ : 63,2% de la valeur finale.',
        'Décharge condensateur : $u_C(t) = U_0 \\cdot e^{-t/\\tau}$. À $t = 5\\tau$ : régime permanent considéré atteint (> 99%)',
      ],
    },

    example: {
      statement: 'Logarithmes et exponentielles — 4 exemples appliqués',
      steps: [
        '<strong>Exemple 1 — Atténuation en dB</strong> : filtre passe-bas atténuant d\'un facteur 100 en tension : $L = 20 \\times \\log_{10}(100) = 20 \\times 2 = 40\\;\\text{dB}$ → signal de sortie à $-40\\;\\text{dB}$.',
        '<strong>Exemple 2 — Demi-vie d\'une réaction d\'ordre 1</strong> : $[A](t) = [A]_0 e^{-kt}$ avec $k = 0{,}05\\;\\text{min}^{-1}$ → $t_{1/2} = \\ln 2 / k = 0{,}693 / 0{,}05 = 13{,}9\\;\\text{min}$.',
        '<strong>Exemple 3 — NTU d\'un échangeur thermique</strong> : $\\varepsilon = 0{,}8 = 1 - e^{-\\text{NTU}}$ → $e^{-\\text{NTU}} = 0{,}2$ → $\\text{NTU} = -\\ln(0{,}2) = 1{,}61$.',
        '<strong>Exemple 4 — Addition de sources sonores</strong> : deux machines à 80 dB chacune → $L_{\\text{tot}} = 10\\log_{10}(2 \\times 10^8) = 10(0{,}301 + 8) = 83\\;\\text{dB}$. Deux sources identiques ajoutent toujours +3 dB.',
      ],
      answer: 'On n\'additionne jamais les dB directement. Règle : +3 dB = ×2 la puissance ; +10 dB = ×10 la puissance perçue.',
    },
