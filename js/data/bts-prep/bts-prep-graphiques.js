...
• <strong>Titre et unités</strong> : indispensables pour donner un sens au graphique.`,
      },
      {
        ...
        def: `Si on connaît deux points $(x_1, y_1)$ et $(x_2, y_2)$ sur une courbe, on peut estimer la valeur $y$ pour un $x$ intermédiaire ($x_1 < x < x_2$) :<br/><br/>
...
C'est l'équation de la droite passant par les deux points connus.`,
    ...
    method: {
      ...
      steps: [
        ...
        '<strong>Pour calculer la pente</strong> : choisir deux points éloignés sur la droite, lire $(x_1, y_1)$ et $(x_2, y_2)$, calculer $a = (y_2 - y_1)/(x_2 - x_1)$, vérifier l\'unité $[a] = [y]/[x]$',
      ],
    },

    example: {
      statement: 'Lecture et interpolation graphique — 4 exemples techniques',
      steps: [
        '<strong>Exemple 1 — Courbe pompe Grundfos</strong> : Pour $Q = 12\\;\\text{m}^3/\\text{h}$ entre les points $(10, 38)$ et $(15, 27)$ : HMT $= 38 + \\frac{12-10}{15-10} \\times (27-38) = 38 - 4{,}4 = 33{,}6\\;\\text{m}$.',
        '<strong>Exemple 2 — Diagramme de Moody (log-log)</strong> : Pour $Re = 10^5$ et $\\varepsilon/D = 10^{-3}$, on lit graphiquement sur l\'abaque double échelle logarithmique $\\lambda \\approx 0{,}021$.',
        '<strong>Exemple 3 — Caractéristique diode</strong> : Pour $V = 0{,}65\\;\\text{V}$ entre $(0{,}60\\;\\text{V}, 10\\;\\text{mA})$ et $(0{,}70\\;\\text{V}, 80\\;\\text{mA})$ : $I = 10 + 0{,}5 \\times 70 = 45\\;\\text{mA}$ (valable si variation quasi-linéaire entre ces deux points).',
        '<strong>Exemple 4 — Diagramme enthalpique (Mollier)</strong> : On lit $h_1$ (entrée compresseur), $h_2$ (sortie compresseur), $h_4$ (entrée évaporateur) pour calculer la puissance frigorifique par kg : $q_f = h_1 - h_4$.',
      ],
      answer: 'Interpolation linéaire : $y = y_1 + \\frac{x-x_1}{x_2-x_1} \\times (y_2-y_1)$. Toujours vérifier axes, unités et limites de validité avant d\'interpoler.',
    },
