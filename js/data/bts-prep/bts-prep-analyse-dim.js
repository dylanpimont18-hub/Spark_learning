...
Longueur → <strong>L</strong> &nbsp;·&nbsp; Masse → <strong>M</strong> &nbsp;·&nbsp; Temps → <strong>T</strong> &nbsp;·&nbsp; Courant électrique → <strong>I</strong> &nbsp;·&nbsp; Température → <strong>θ</strong> &nbsp;·&nbsp; Quantité de matière → <strong>N</strong><br/><br/>
Notation : $[x]$ désigne "la dimension de la grandeur x".<br/><br/>
Exemples :<br/>
$[v] = \\text{L·T}^{-1}$ (vitesse = longueur par temps)<br/>
...
Exemples : nombre de Reynolds $Re = \\rho v D / \\mu$, rendement $\\eta = P_{\\text{utile}} / P_{\\text{absorbée}}$, COP.`,
    ...
    method: {
      title: 'Méthode de vérification et détermination dimensionnelle',
      steps: [
    ...
    example: {
      statement: 'Vérification de $E = \\frac{1}{2}mv^2$ (énergie cinétique)',
      steps: [
        '$[m] = \\text{M}$, $[v] = \\text{L·T}^{-1}$',
        '$\\left[\\frac{1}{2}mv^2\\right] = \\text{M} \\times (\\text{L·T}^{-1})^2 = \\text{M·L}^2\\text{·T}^{-2}$',
        '$[E] = \\text{J} = \\text{M·L}^2\\text{·T}^{-2}$ ✓ — La formule est homogène.',
        `<strong>Exemple 2 — Détection d'erreur : $P = F \\times v^2$ (faux !)</strong><br/>$[F \\times v^2] = \\text{M·L·T}^{-2} \\times (\\text{L·T}^{-1})^2 = \\text{M·L}^3\\text{·T}^{-4}$<br/>$[P] = \\text{W} = \\text{M·L}^2\\text{·T}^{-3}$ → formule <strong>fausse</strong>. La formule correcte est $P = F \\times v$.`,
        `<strong>Exemple 3 — Électrotechnique : $U = \\sqrt{P \\times R}$</strong><br/>$[P \\times R] = \\text{M}^2\\text{·L}^4\\text{·T}^{-6}\\text{·I}^{-2}$<br/>$\\left[\\sqrt{P \\times R}\\right] = \\text{M·L}^2\\text{·T}^{-3}\\text{·I}^{-1} = [\\text{V}]$ ✓`,
      ...
      answer: `L'équation est homogène car $[\\text{m gauche}] = [\\text{m droite}] = \\text{M·L}^2\\text{·T}^{-2}$. Règle : une formule non homogène est forcément fausse ; une formule homogène peut encore comporter une erreur numérique.`,
    },
